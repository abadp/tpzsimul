...
#define __TPZCrossbarFlowCTMux_HPP__
...
//*************************************************************************
   ...
   class TPZCrossbarFlowCTMux : public TPZCrossbarFlow
   {
      typedef TPZCrossbarFlow Inhereited;
      
   public:
      TPZCrossbarFlowCTMux( TPZComponent& component);
      virtual ~TPZCrossbarFlowCTMux();
      ...
      DEFINE_RTTI(TPZCrossbarFlowCTMux);
