...
#define __TPZDemultiplexorFlow_HPP__
...
//*************************************************************************
   ...
   class TPZDemultiplexorFlow : public TPZFlow
   {
      typedef TPZFlow Inhereited;
      
   public:
      TPZDemultiplexorFlow( TPZComponent& component);
      ...
      void setCurrentOutput( unsigned output)
         { m_CurrentOutput= output; }
	 
            
      // Run time information
      DEFINE_RTTI(TPZDemultiplexorFlow);
