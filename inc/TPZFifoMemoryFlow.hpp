...
#ifndef __TPZFifoMemoryFlow_HPP__
#define __TPZFifoMemoryFlow_HPP__
...
//*************************************************************************
   ...
   class TPZFifoMemoryFlow : public TPZFlow
   {
      typedef TPZFlow Inhereited;

   public:
      TPZFifoMemoryFlow( TPZComponent& component);
      ...
      Boolean getControlTail()
      { return m_ControlTail; }
      
      void setControlTail(Boolean aux)
      { m_ControlTail=aux; }
