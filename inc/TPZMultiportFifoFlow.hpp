...
#define __TPZMultiportFifoFlow_HPP__
...
typedef TPZQueue<TPZMessage*> QueueFlits;
   ...
   class TPZMultiportFifoFlow : public TPZFlow
   {
      typedef TPZFlow Inhereited;

   public:
      TPZMultiportFifoFlow( TPZComponent& component);
      virtual ~TPZMultiportFifoFlow();
      ...
      virtual Boolean controlAlgoritm (Boolean info, int delta);
      
      // Run time information
      DEFINE_RTTI(TPZMultiportFifoFlow);
