...
//****************************************************
   ...
   class TPZPortOutput : public TPZPort
   {
   public:
      TPZPortOutput( const TPZComponentId& id);
      virtual ~TPZPortOutput();
