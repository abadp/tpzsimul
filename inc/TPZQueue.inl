...
template <class T>
Boolean TPZQueue<T> :: enqueue(const T& data)
{
...
template <class T>
Boolean TPZQueue<T> :: insertfirst(const T& data)
{
...
template <class T>
Boolean TPZQueue<T> :: dequeue(T& data)
{
...
template <class T>
Boolean TPZQueue<T> :: firstElement(T& data)
{
   if( this->isValid() )
   {
      data = this->getRoot()->element();
