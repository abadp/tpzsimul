...
//end of header
 ...
 //************************************************************************
    ...
    class TPZRouting : public TPZRunnableComponent
    {
    ...
    public:
       ...
       TPZRouting(const TPZComponentId& id, TPZRoutingControl control);
       virtual ~TPZRouting();
       ...
       DEFINE_RTTI(TPZRouting);

    protected:
       virtual void buildFlowControl();

    private:
       static TPZRouting* newFrom(const TPZTag* tag, TPZComponent* owner);
