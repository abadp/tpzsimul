...
//*************************************************************************
//:
//    File: TPZRoutingMuxedFlowBubble.hpp
//
//    Class: 
//
//    Inherited from: 
...
#define __TPZRoutingMuxedFlowBubble_HPP__
...
//*************************************************************************
   ...
   class TPZRoutingMuxedFlowBubble : public TPZRoutingMuxedFlow
   {
      typedef TPZRoutingFlow Inhereited;
      
   public:
      TPZRoutingMuxedFlowBubble( TPZComponent& component);
      
      virtual void postInitialize();
      virtual Boolean controlAlgoritm();
      
      // Run time information
      DEFINE_RTTI(TPZRoutingMuxedFlowBubble);
