...
//*************************************************************************
   ...
   template <class T>
   class TPZSequence : public  TPZBaseCollection<T>
   {
      typedef TPZBaseCollection<T> Inhereited;
    public:
      typedef TPZCursor<T> Cursor;

   public:
      TPZSequence();
      TPZSequence(const TPZSequence<T>& aSeq);
