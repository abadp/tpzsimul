...
//*************************************************************************
//:
//    File: TPZSimpleRouterFlowBinoc.hpp
//
//    Class: 
//
//    Inherited from: 
...
#define __TPZSimpleRouterFlowBinoc_HPP__
...
//*************************************************************************
   ...
   class TPZSimpleRouterFlowBinoc : public TPZFlow
   {
      typedef TPZFlow Inhereited;
      
   public:
      TPZSimpleRouterFlowBinoc( TPZComponent& component);
      virtual ~TPZSimpleRouterFlowBinoc();
      ...
      DEFINE_RTTI(TPZSimpleRouterFlowBinoc);
   ...
   protected:
      ...
      virtual  TPZROUTINGTYPE getTipoReverse(TPZROUTINGTYPE tipo);
      virtual  unsigned extractOutputPortNumber(TPZROUTINGTYPE dir, Boolean reverse);
      virtual  unsigned extractOutputPortNumber(TPZMessage* msg, Boolean reverse);
