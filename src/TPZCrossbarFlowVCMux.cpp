...
//*************************************************************************
//:
//    File: TPZCrossbarFlowVCMux.cpp
//
//    Class:  TPZCrossbarFlowVCMux
//
...
IMPLEMENT_RTTI_DERIVED(TPZCrossbarFlowVCMux,TPZCrossbarFlowVC);

//*************************************************************************
//:
//  f: TPZCrossbarFlowVCMux ();
//
//  d:
//:
//*************************************************************************

TPZCrossbarFlowVCMux :: TPZCrossbarFlowVCMux( TPZComponent& component)
...
void TPZCrossbarFlowVCMux :: initialize()
{
...
//:
//*************************************************************************
Boolean TPZCrossbarFlowVCMux :: dispatchEvent(const TPZEvent& event)
{
...
void TPZCrossbarFlowVCMux ::  setStateForInputPort(unsigned i, TPZState state)
{
...
TPZState TPZCrossbarFlowVCMux ::  getStateForInputPort(unsigned i)
{
...
//:
//*************************************************************************
unsigned TPZCrossbarFlowVCMux :: getFisicalIportFor( unsigned iPort )
{
