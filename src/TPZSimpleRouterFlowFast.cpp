...
//*************************************************************************
//:
//    File: TPZSimpleRouterFlowFast.cpp
//
//    Class:  TPZSimpleRouterFlowFast
//
...
IMPLEMENT_RTTI_DERIVED(TPZSimpleRouterFlowFast,TPZSimpleRouterFlow);

//*************************************************************************
//:
//  f: TPZSimpleRouterFlowFast ();
//
//  d:
//:
//*************************************************************************

TPZSimpleRouterFlowFast :: TPZSimpleRouterFlowFast( TPZComponent& component)
...
TPZSimpleRouterFlowFast :: ~TPZSimpleRouterFlowFast()
{
}
...
//:
//*************************************************************************
Boolean TPZSimpleRouterFlowFast :: inputReading()
{  
   unsigned outPort;
   unsigned inPort;
   ...
   // We move the data flits already established connections
   //**********************************************************************************************************
   ...
   {   
	 ...
	 if(inPort>m_ports)continue;
      ...
      // If there is a message at routing
