...
//*************************************************************************
//:
//    File: TPZSimpleRouterFlowWH.cpp
//
//    Class:  TPZSimpleRouterFlowWH
//
...
IMPLEMENT_RTTI_DERIVED(TPZSimpleRouterFlowWH,TPZSimpleRouterFlow);

//*************************************************************************
//:
//  f: TPZSimpleRouterFlowWH ();
//
//  d:
//:
//*************************************************************************

TPZSimpleRouterFlowWH :: TPZSimpleRouterFlowWH( TPZComponent& component)
...
TPZSimpleRouterFlowWH :: ~TPZSimpleRouterFlowWH()
{
}
...
Boolean TPZSimpleRouterFlowWH :: outputWriting()
{
   unsigned inPort;
   TPZNetwork* net = ((TPZSimulation*)(getComponent().getSimulation()))->getNetwork();
   unsigned roundTripDelay = net->getConnectionDelay()+1;
   unsigned virtualChannel; 
   ...
   for( inPort = 1; inPort <= m_ports*m_vnets; inPort++)
   {
      ...
      if((m_bufferSize - m_fifos[inPort].numberOfElements()) <= roundTripDelay)
      {
